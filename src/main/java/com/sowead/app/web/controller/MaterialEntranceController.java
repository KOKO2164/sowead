...
public class MaterialEntranceController {
    ...
    public MaterialEntrance updateStatus(@PathVariable("id") int materialEntranceId,
            @RequestBody MaterialEntrance materialEntrance) {
        return materialEntranceService.updateStatus(materialEntranceId, materialEntrance);
    }
